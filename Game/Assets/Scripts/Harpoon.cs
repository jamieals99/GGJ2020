...
public class Harpoon : MonoBehaviour
{
    ...
    public GameObject harpoonManager;
    ...
    void FixedUpdate()
    {
        if (harpoonManager.GetComponent<HarpoonGun>().usingHarpoon == true)
        {
            ...
            else if (Input.GetMouseButtonDown(0) && fired == true)
            {
                ...
                transform.position = new Vector3(cam.transform.position.x - 2.5f, cam.transform.position.y + airship.transform.position.y - 0.9f - 1f, 0);
                fired = false;
            }
        }
    }
